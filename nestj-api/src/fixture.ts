...
async function bootstrap() {
  ...
  await app.init(); //não manter nenhum processo rodando, somente iniciar a instância da aplicação

  // getDataSourceToken() -> devolve o nome do serviço da conexão que está registrado no container de serviços do Nest
  const dataSource = app.get<DataSource>(getDataSourceToken());
  await dataSource.synchronize(true); // mata todas as tabelas e recria novamente
